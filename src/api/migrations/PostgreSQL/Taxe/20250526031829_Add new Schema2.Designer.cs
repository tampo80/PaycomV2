...
namespace PayCom.WebApi.Migrations.PostgreSQL.Taxe
{
    ...
    [Migration("20250526031829_Add new Schema2")]
    partial class AddnewSchema2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Commune", b =>
                {
                    ...
                    b.Property<Guid?>("RegionId2")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RegionId3")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RegionId4")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RegionId5")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RegionId6")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RegionId3");

                    b.HasIndex("RegionId4");

                    b.HasIndex("RegionId5");

                    b.HasIndex("RegionId6");
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Commune", b =>
                {
                    ...
                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("Arrondissements")
                        .HasForeignKey("RegionId1");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("CommunesRurales")
                        .HasForeignKey("RegionId2");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("CommunesSpeciales")
                        .HasForeignKey("RegionId3");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("CommunesStandard")
                        .HasForeignKey("RegionId4");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("CommunesUrbaines")
                        .HasForeignKey("RegionId5");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Region", null)
                        .WithMany("Municipalites")
                        .HasForeignKey("RegionId6");
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Region", b =>
                {
                    ...
                    b.Navigation("CommunesRurales");

                    b.Navigation("CommunesSpeciales");

                    b.Navigation("CommunesStandard");

                    b.Navigation("CommunesUrbaines");
