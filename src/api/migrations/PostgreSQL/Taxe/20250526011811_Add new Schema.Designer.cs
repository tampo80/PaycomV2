...
namespace PayCom.WebApi.Migrations.PostgreSQL.Taxe
{
    ...
    [Migration("20250526011811_Add new Schema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.ObligationFiscale", b =>
                {
                    ...
                    b.ToTable("ObligationFiscales", "taxe");
                });
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Province", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Commune", b =>
                {
                    b.HasOne("PayCom.WebApi.Taxe.Domain.Province", "Province")
                        .WithMany("Communes")
                        .HasForeignKey("ProvinceId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Province", null)
                        .WithMany("CommunesRurales")
                        .HasForeignKey("ProvinceId1");

                    b.HasOne("PayCom.WebApi.Taxe.Domain.Province", null)
                        .WithMany("CommunesUrbaines")
                        .HasForeignKey("ProvinceId2");
            ...
            modelBuilder.Entity("PayCom.WebApi.Taxe.Domain.Province", b =>
                {
                    b.HasOne("PayCom.WebApi.Taxe.Domain.Commune", "ChefLieu")
                        .WithMany()
