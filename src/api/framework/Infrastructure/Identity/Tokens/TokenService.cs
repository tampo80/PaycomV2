...
public sealed class TokenService : ITokenService
{
    ...
    private async Task<string> GenerateJwt(FshUser user, string ipAddress) =>
    ...
    private async Task<List<Claim>> GetClaims(FshUser user, string ipAddress)
    {
        ...
        // Ajouter les rôles de l'utilisateur comme claims
